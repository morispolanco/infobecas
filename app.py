...
def get_scholarship_info(campo_estudio, pais, nivel_estudios, fecha_limite):
    # Construir el prompt para la API de Together
    prompt = f"Proporciona información sobre becas para estudiar {campo_estudio} en {pais} para nivel {nivel_estudios} con fecha límite cercana a {fecha_limite}. Incluye nombres de becas, requisitos básicos y enlaces si están disponibles."
...
if st.button("Buscar becas"):
    if campo_estudio and pais and nivel_estudios and fecha_limite:
        ...
        ai_info, search_results = get_scholarship_info(campo_estudio, pais, nivel_estudios, fecha_limite_str)
